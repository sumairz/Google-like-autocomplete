...
/* Below modified code with get the keywords from a JSON file */

// Your file path
var filePath = "YOUR JSON FILE PATH";
availableTags = []; // Global array
...
$.ajax({
    ...
    success: function (response) {
		$.each(response, function(key, value){
		    availableTags.push(key);	// Filling the availableTags array with my values from JSON file
		});
       }	   
});
...
// Hard coded array with keywords
/*var availableTags = [
    "ActionScript",
    "AppleScript",
    "Asp",
